...
<body>
    <section>
        ...
        <h4>
            Welcome to KBS! I hope you will find our tool to accelarate your sales. Here's your username and password.
        </h4>
        <h4>
            Username: {{ $vendor_username }}
        </h4>
        <h4>
            Passowrd: {{ $vendor_password }}
        </h4>
        <h4 style="color:red">Please do not share this information with anyone.</h4>
