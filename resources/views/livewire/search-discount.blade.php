                        ...
                        <td>
                            <div class="action-wrapper">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" id="{{$discount->discount_id}}">
                                                <form name="edit-discount" data-discount-id="{{$discount->discount_id}}">
                                                    <input type="hidden" class="kbs-input" name="discount_id"
                                                    value="{{ $discount->discount_id }}">
                                                    <input type="number" class="kbs-input" name="discount_percentage"
                                ...
                                @if ($discount->books->isNotEmpty())
                                    <button  data-bs-toggle="modal" data-bs-target="#removeDiscount" data-toggle="tooltip" data-placement="top"
                                        title="Remove Discounts from Books"><i class="fa-solid fa-tag"></i></button>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" id="removeDiscount">
                                                        @foreach($discount->books as $book)
                                                        <div class="d-flex justify-content-between align-items-center mb-3" data-book-id={{$book->book_id}} data-remove-book-id={{$book->book_id}}>
                                                            <h4>{{$book->book_name}}</h4>
                                                            <i class="fa-solid fa-x" data-book-id="{{ $book->book_id }}"
                                                                data-route="{{ route('vendor.discount-remove') }}" data-token="{{ session('userToken') }}" data-discount-id={{$discount->discount_id}}></i>
                                                        </div>
                                                        @endforeach    
                                                    ...
                                                    data-token="{{ session('userToken') }}"
                                                    data-discount-id="{{$discount->discount_id}}">Remove All</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                data-toggle="tooltip" data-placement="top"
                                    title="Delete Discount"><i class="fa-solid fa-trash" data-route="{{route('vendor.discount-delete')}}" 
                                    data-discount-id="{{$discount->discount_id}}" data-token="{{session('userToken')}}"></i></a>
                            </div>
                        </td>
                    </tr>
                @endforeach
